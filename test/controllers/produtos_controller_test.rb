...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { active: @produto.active, description: @produto.description, title: @produto.title, value: @produto.value }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { active: @produto.active, description: @produto.description, title: @produto.title, value: @produto.value }
    assert_redirected_to produto_path(assigns(:produto))
  end
